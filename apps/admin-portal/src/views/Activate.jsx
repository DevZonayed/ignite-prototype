...
/** The roles this portal actually signs people in as. */
const PORTAL_ROLES = ['platform_admin', 'curriculum_admin']
 ...
 *
 * The invite code is single-use and any role can redeem it here, so an
 * administrator is signed straight in while everyone else gets told which app to
 * open next — dropping a teacher into the admin portal would only show them errors.
 */
