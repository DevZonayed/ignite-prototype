...
// The parent theme has no ignite gradient export; the brand ramp is defined
// once here so the tile and the warm hero orb stay in step.
export const igniteGradient = ['#FBBF24', '#F97316'];

/**
 * Auth chrome, shared with the teacher app.
 *
 * The three apps are one product, so a parent signing in should meet the same
 * screen their child's teacher does: a gradient hero carrying the brand, and the form
